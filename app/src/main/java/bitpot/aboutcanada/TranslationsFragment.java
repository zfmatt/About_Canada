...
public class TranslationsFragment extends android.support.v4.app.Fragment implements OnItemSelectedListener{
    ...
    public static int  dictionn;
    public static int  dictionOld;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            diction = new int[9];
            diction[0] = R.raw.dictionaryfrench;
            diction[1] = R.raw.dictionaryarabic;
            diction[2] = R.raw.dictionarychinesesimplified;
            diction[3] = R.raw.dictionarychinesetraditional;
            diction[4] = R.raw.dictionaryfilipino;
            diction[5] = R.raw.dictionaryhindi;
            diction[6] = R.raw.dictionarypunjabi;
            diction[7] = R.raw.dictionarypersian;
            diction[8] = R.raw.dictionarytamil;
            View view = inflater.inflate(R.layout.fragment_translationblank, null);
            refressh = container;
    ...
    public void DispFileText(LinearLayout ll){
        ...
        ll.addView(lineDr);
        InputStream is = getResources().openRawResource(dictionn);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        dictionn=diction[position-1];

        if (dictionn != dictionOld){
